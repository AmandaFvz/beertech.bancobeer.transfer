...
public class TransactionController {
  ...
  @PostMapping
  public ResponseEntity<Transaction> executeTransaction(@RequestBody TransactionRequestTO transactionTO) {

    Transaction createdTransaction = transactionService.executeTransaction(transactionTO);
